...
function ShowInput() {
 ...
 ///####################INSERIMENTO DINAMICO DALLA FORM##############################///
  ...
  var dataDiNascita = document.getElementById('dateofbirth').value;
...
//#VERSIONE STATICA
  ...
  //Test 1
  //para.innerHTML = consonanti_prese_cognome + " " +  consonanti_prese_nome + " " + anno + mese + giorno + localita_presa;
  ...
  para.innerHTML = CF_FX + lettera_controllo;
